...
class OrderLinesControllerTest < ActionController::TestCase
  ...
  test "should create order_line" do
    assert_difference('OrderLine.count') do
      post :create, order_line: { order_id: @order_line.order_id, product_id: @order_line.product_id, quantity_id: @order_line.quantity_id }
    end
  ...
  test "should update order_line" do
    patch :update, id: @order_line, order_line: { order_id: @order_line.order_id, product_id: @order_line.product_id, quantity_id: @order_line.quantity_id }
    assert_redirected_to order_line_path(assigns(:order_line))
  end
